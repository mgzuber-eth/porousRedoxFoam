...
// * * * * * * * * * * * * * Make Solid irreverisble reactions  * * * * * * * * * * * * //

//makeIReactions(solidArrheniusReactionRate)
//makeIReactions(solidTemperatureArrheniusReactionRate)
//makeIReactions(solidModArrRate)
//makeIReactions(solidConstRate)

// * * * * * * * * * * * * * Make Solid reverisble reactions  * * * * * * * * * * * * //	
